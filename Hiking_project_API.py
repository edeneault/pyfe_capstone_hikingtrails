...
#    This mini application is a program that prompts the user to input         #
#    COORDINATES and SEARCH AREA RANGE and returns the TOP 10 hiking trails    #
#    in the SEARCH AREA.The program also produces a interactive data           #
#    visualization data visualization using Bokeh.                             #
################################################################################
...
# Hikingproject.com API is open ton everyone, just register for a free account and an API key is assigned automatically.
# It is also sent to you by email.  Easy beans!
...
if __name__ == "__main__":
    ...
    while True:
        ...
        visual = input('***** To view a interactive visualization, PRESS ENTER *****')
        print()
        print("Visualization loading....")
        if len(visual) < 1: visualpass.visualization()
